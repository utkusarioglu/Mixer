...
test("set_GlobalNamespace", () => {
    ...
    const cls_sample = class extends mixer_1.Parent().with(namespace_1.M_Namespace) {
        constructor() {
            super();
...
test("set_GlobalNamespace", () => {
    ...
    const cls_sample = class extends mixer_1.Parent().with(namespace_1.M_Namespace, state_1.M_State) {
        constructor() {
            super();
            this.set_GlobalNamespace(namespace_input);
...
test("dummy parent", () => {
    ...
    const child_class = class extends mixer_1.Parent(parent_class).with(namespace_1.M_Namespace, library_1.M_Library, controller_1.M_Controller, state_1.M_State) {
        constructor() {
            super();
